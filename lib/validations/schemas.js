...
export const registerSchema = z.object({
  ...
  role: z.enum(['broker', 'client'], {
    errorMap: () => ({ message: 'Role must be either broker or client' }),
  }),
  phone: z
    .string()
...
export const propertySchema = z.object({
  ...
  purpose: z.enum(['sale', 'rent'], {
    errorMap: () => ({ message: 'Purpose must be either sale or rent' }),
  }),
  price: z
    .number()
  ...
  features: z
    .array(z.string())
    .optional(),
  status: z.enum(['active', 'closed', 'sold', 'rented'], {
    errorMap: () => ({ message: 'Status must be active, closed, sold, or rented' }),
  }).optional(),
});
...
export const dealSchema = z.object({
  ...
  dealType: z.enum(['sale', 'rent'], {
    errorMap: () => ({ message: 'Deal type must be either sale or rent' }),
  }),
  dealValue: z
    .number()
